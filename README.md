...
- ⭐2025-3-26: GeoGround：用于遥感视觉接地的统一大型视觉语言模型(目标检测)
...
- 2025-ISPRS. [**Paper**](https://www.sciencedirect.com/science/article/pii/S0924271625000206)  
    ...
    **SkyEyeGPT:** Unifying Earth Observation with Agglomerative Vision-Language Foundation Models
...
- 2025-CVPR. [**Paper**](http://arxiv.org/abs/2410.01768) | [**主页**](https://likyoo.github.io/SegEarth-OV/)   | [**github(code)**](https://github.com/likyoo/SegEarth-OV)  
    ...
    **SkySense-OV:** Towards Open-World Remote Sensing Interpretation with Vision-Centric Visual-Language Modeling
...
- 2024-arxiv. [**Paper**](https://arxiv.org/abs/2411.11904#:~:text=This%20paper%20proposes%20GeoGround%2C%20a%20novel%20framework%20that,RS%20visual%20grounding%20tasks%2C%20allowing%20flexible%20output%20selection.) | [**github(no code)**](https://github.com/zytx121/GeoGround) 

    **GeoGround:** A Unified Large Vision-Language Model for Remote Sensing Visual Grounding
    </br>本文提出了 GeoGround，这是一个新颖的框架，它统一了对 HBB、OBB 和掩码 RS 视觉接地任务的支持，允许灵活地选择输出。
    我们的工作不是定制 VLM 的架构，而是通过 Text-Mask 技术优雅地支持像素级视觉接地输出。我们定义了提示辅助和几何引导学习，以增强不同信号之间的一致性。
    为了支持模型训练，提出了 refGeo，这是一个包含 161k 个图像文本对的大规模 RS 视觉指令跟踪数据集。
    实验结果表明，GeoGround 在四个 RS 视觉接地任务中表现出色，在多个基准测试中达到或超越了专门方法的性能。
